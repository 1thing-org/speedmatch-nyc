...
export const FixedQuestions = [
  {
    ...
    options: [
      { id: '1', label: 'Focused on stopping drug trafficking and helping people recover rather than traditional policing', candidateIds: [1, 3] as CandidateId[] },
      { id: '2', label: 'Hire 5,000+ NYPD Officers + Pinpoint high-crime locations and repeat offenders', candidateIds: [2] },
